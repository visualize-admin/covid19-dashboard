...
import { CardOverviewHospCapacityComponent } from './card-overview-hosp-capacity.component'

@NgModule({
  declarations: [CardOverviewHospCapacityComponent],
  imports: [
    CommonModule,
    OverviewCardModule,
    CommonsModule,
  ...
  exports: [CardOverviewHospCapacityComponent],
})
export class CardOverviewHospCapacityModule {}
