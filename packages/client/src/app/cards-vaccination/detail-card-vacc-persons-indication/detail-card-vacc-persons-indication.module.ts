...
import { DetailCardVaccPersonsIndicationComponent } from './detail-card-vacc-persons-indication.component'

@NgModule({
  declarations: [DetailCardVaccPersonsIndicationComponent],
  imports: [
    CommonModule,
    DetailCardModule,
    CommonsModule,
  ...
  exports: [DetailCardVaccPersonsIndicationComponent],
})
export class DetailCardVaccPersonsIndicationModule {}
