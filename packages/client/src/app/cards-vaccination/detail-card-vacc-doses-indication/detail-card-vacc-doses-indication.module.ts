...
import { DetailCardVaccDosesIndicationComponent } from './detail-card-vacc-doses-indication.component'

@NgModule({
  declarations: [DetailCardVaccDosesIndicationComponent],
  imports: [
    CommonModule,
    DetailCardModule,
    CommonsModule,
  ...
  exports: [DetailCardVaccDosesIndicationComponent],
})
export class DetailCardVaccDosesIndicationModule {}
