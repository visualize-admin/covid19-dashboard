...
import { DetailCardVaccDosesVaccineComponent } from './detail-card-vacc-doses-vaccine.component'

@NgModule({
  declarations: [DetailCardVaccDosesVaccineComponent],
  imports: [
    CommonModule,
    DetailCardModule,
    CommonsModule,
  ...
  exports: [DetailCardVaccDosesVaccineComponent],
})
export class DetailCardVaccDosesVaccineModule {}
