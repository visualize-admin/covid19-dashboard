...
import { DetailCardVaccDosesLocationComponent } from './detail-card-vacc-doses-location.component'

@NgModule({
  declarations: [DetailCardVaccDosesLocationComponent],
  imports: [
    CommonModule,
    DetailCardModule,
    CommonsModule,
  ...
  exports: [DetailCardVaccDosesLocationComponent],
})
export class DetailCardVaccDosesLocationModule {}
