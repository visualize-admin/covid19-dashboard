...
import { DetailCardVaccStatusVaccineComponent } from './detail-card-vacc-status-vaccine.component'
...
@NgModule({
  ...
  declarations: [DetailCardVaccStatusVaccineComponent],
  exports: [DetailCardVaccStatusVaccineComponent],
})
export class DetailCardVaccStatusVaccineModule {}
