...
import { DetailCardVaccStatusDevelopmentComponent } from './detail-card-vacc-status-development.component'
...
@NgModule({
  ...
  declarations: [DetailCardVaccStatusDevelopmentComponent],
  exports: [DetailCardVaccStatusDevelopmentComponent],
})
export class DetailCardVaccStatusDevelopmentModule {}
